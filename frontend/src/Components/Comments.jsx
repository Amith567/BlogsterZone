    ...
    <>
      <div className='my-3 border w-full rounded-md p-2'>
        <div className='flex flex-col'>
          <p className='font-semibold underline cursor-pointer text-blue-900'>
            <Link to={`/${comment.commented_by_id}/profile`} className="underline cursor-pointer text-blue-900">
